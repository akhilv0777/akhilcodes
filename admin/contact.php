                  ...
                  if ($result) :
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-outline-primary reply-button" data-email="<?php echo $row['email']; ?>" data-message_id="<?php echo $row['id']; ?>" data-toggle="modal" data-target="#exampleModalCenter">
